...
pub fn try_match(
    ...
    while !opposite_slab.nodes.is_empty() && remaining_qty > 0 {
        let fill = {
            ...
            // Trade only the minimum quantity
            let fill_qty = best.quantity.min(remaining_qty);
        ...
        // Reduce taker's remaining quantity
